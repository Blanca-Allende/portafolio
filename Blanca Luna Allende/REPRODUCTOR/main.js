...
const defaultImage = './img/Clo7-2.jpg'; 
const playImage = './img/Clo7.gif'; 
...
const songs = [ 
        ...
        {
        name: "Live With Abandon",
        author: "Newsboys",
        path: "./songs/Newsboys - Live With Abandon.mp3",
    },
         {
        name: "We Believe",
        author: "Newsboys",
        path: "./songs/Newsboys - We Believe.mp3",
    },
         {
        name: "The King Is Coming",
        author: "Newsboys",
        path: "./songs/The King Is Coming.mp3",
    }
    //  
    //   {
